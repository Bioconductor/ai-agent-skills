...
| [Bioconductor/BiocPkgReviewer](https://github.com/Bioconductor/BiocPkgReviewer) (private; the agent-assisted reviewer) | rubric sha256 `29c48ccbf2bb` (its `docs/rubric.yaml`, exported 2026-09-23) | 2026-09-23 | `../../bioc-pkg-review/knowledge/rubric.{yaml,md}` (regenerate with its `rubric.py --export`), the review-derived notes in `../../bioc-pkg-review/SKILL.md`, and the sentence in [../SKILL.md](../SKILL.md) step 8 about how its triage pass reads the provenance statement |
